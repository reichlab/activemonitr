...
output:
  word_document:
    ...
    reference_docx: eid-word-style.docx
  pdf_document:
    fig_caption: yes
    fig_height: 5
    fig_width: 5
...
__Article Summary Line:__ 
Monitoring individuals potentially exposed to infectious pathogens can save lives and minimize resource-intensive response to high-consequence events, but the costs of monitoring and responding to false alarms are also significant.


__Running Title:__ 
Costs of Active Monitoring for Infectious Diseases


__Keywords:__ 
Public Health; Global Health; Public Health Surveillance; Epidemiological Monitoring; Disease Outbreaks; Centers for Disease Control and Prevention (U.S.); New York City; Ebolavirus; Hemorrhagic Fever, Ebola; Middle East Respiratory Syndrome Coronavirus; Smallpox; Variola virus
...
For monitored individuals deemed "low (but not zero) risk" or "some or high risk" of Ebola, we identified unique durations of active monitoring that minimize expected costs for each scenario: 21 and 31 days, respectively. Additionally, we extended this analysis to hypothetical outbreaks of smallpox and MERS-CoV. 
Active monitoring can save lives, but the costs of monitoring and responding to false alarms are also significant. 
...
```{r figure2-estimated-distribution-dynamic, fig.path='static-figures/', fig.show='hide', fig.height=5, cache=FALSE, eval=FALSE}
data(kde_smallpox) 
data(kde_ebola)
data(kde_mers)
...
# Acknowledgments
We thank the individuals who underwent active monitoring in NYC, Ifeoma Ezeoke for preparing the DOHMH active monitoring data and Margaret Pletnikoff for preparing the DOHMH cost data. We thank Simon Cauchemez, Amadou Sall, and Ousmane Faye for providing access to the Ebola incubation period data from Guinea and giving permission for this data to be made publicly available. We also acknowledge John Maher for providing details on costs of evaluating Ebola patients at Bellevue Hospital in New York City.

# Biographical Sketch
Dr. Nicholas Reich is an Assistant Professor of Biostatistics at the University of Massachusetts - Amherst. His research focuses on developing and applying statistical methods for analyzing infectious disease surveillance data. 
...
<!--static-figures/figure3-scaled-prob-symptoms.pdf-->
