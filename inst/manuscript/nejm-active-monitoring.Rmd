...
We developed a model that uses varying probabilities to alter the incubation period, and thus estimates whether active monitoring would identify an individual infected with the pathogen of interest. Figure 1 presents the model schema, which involves a monitored individual having one of four outcomes: 
...
# Acknowledgments
We thank the individuals who underwent active monitoring in NYC and Ms. Ifeoma Ezeoke for preparing the DOHMH active monitoring data. We thank Dr. Simon Cauchemez, PhD (Institut Pasteur, Paris, France) and Dr. Amadou Sall, PhD (Institut Pasteur, Dakar, Senegal)  for providing access to the Ebola incubation period data from Guinea and giving permission for this data to be made publicly available. We also acknowledge Mr. John Maher for providing details on costs of evaluating Ebola patients at Bellvue Hospital in New York City.
