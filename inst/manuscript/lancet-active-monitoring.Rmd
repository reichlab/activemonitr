...
__Background__    
During outbreaks of deadly emerging pathogens (e.g., Ebola, MERS-CoV) and bioterror threats (e.g., smallpox), actively monitoring potentially infected individuals may help limit disease transmission and morbidity. There is limited data about how to balance the costs and performance of this important public health activity.


__Methods__    
We estimate the risks and costs associated with specific durations of active monitoring for three pathogens of significant public health concern: MERS-CoV, Ebola, and Smallpox. Specifically, we model the risk of individuals becoming symptomatic from the disease of interest and other causes. As a case-study, we analyze data from New York City's Ebola active monitoring program. Guidance issued by CDC on active monitoring was a critical cornerstone of its response to the West Africa Ebola outbreak. Individuals under Ebola active monitoring were asked to contact local health authorities to report their health status every day for 21 days after their last potential exposure.

__Findings__    
For monitored individuals in the CDC exposure-risk categories of "low (but not zero) risk" or "some or high risk" of Ebola, we estimated the probabilities of infection to be 1/10,000 and 1/1,000, respectively. Using these estimates, our model identified unique durations of active monitoring for Ebola that would minimize expected costs for each scenario: 21 and 31 days, respectively. The chances of seeing a long incubation period (i.e. greater than three weeks) is greater for Ebola than for either MERS-CoV or Smallpox. In general, this translates into longer recommended active monitoring period durations for Ebola when compared to the other two pathogens.
...
Active monitoring is a relatively new countermeasure used by public health officials across the world to combat emerging infectious disease outbreaks. However, there is limited data about how to balance the cost and performance of this important public health activity. Our study is the first to explicitly assess the risks and costs associated with active monitoring programs, providing a flexible model that can be used for a wide range of outbreakscenarios. 
...
median incubation periods)
of monitoring (Figure 4). The model results are sensitive to the uncertainties in the cost per day of monitoring and the number of secondary cases. For example, if the upper limit of the cost increases from $20 to $40/day or the number of secondary cases decreases from 4 to 2, the durations of monitoring that would minimize expected cost decrease by 2-3 days for each scenario.
...
Active monitoring is useful for minimizing risk in critical, real-time outbreak response. Our framework for evaluating active monitoring of infectious diseases provides valuable information to assess the cost-effectiveness of various approaches. These tools could be used to strengthen the biosecurity of the U.S. and other countries as well as to help guide future assessments and data collection on active monitoring programs. They also provide a pathway for data to inform the design of active monitoring programs for future global disease threats.
