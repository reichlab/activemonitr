...
__Methods__    
We model the risk of individuals becoming symptomatic from the disease of interest and other causes, estimating the risks and costs associated with active monitoring programs. As a case-study, we analyze data from New York City's active monitoring program during the West Africa Ebola outbreak.

__Findings__    
For three pathogens of significant public health concern, we quantified the risk and costs associated with specific durations of active monitoring. During the West Africa Ebola outbreak, CDC recommended active monitoring for 21 days after the last potential exposure. For monitored individuals in the CDC exposure-risk categories of "low (but not zero) risk" or "some or high risk" of Ebola, we estimated the probabilities of infection to be 1/10,000 and 1/1,000, respectively. Using these estimates, our model identified unique durations of active monitoring for Ebola that would minimize expected costs for each scenario: 21 and 31 days, respectively.
...
median incubation periods)
of monitoring (Figure 4). The model results are sensitive to the cost per day of monitoring. For example, if the upper limit of the cost increases to $40/day, the durations of monitoring that would minimize expected cost decrease by 3 days for each scenario.
