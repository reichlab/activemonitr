---
title: 'Methodological supplement for: Quantifying the Risk and Cost of Active Monitoring for Infectious Diseases'
...
All incubation period observations were treated as single interval-censored data, which means that intervals of possible incubation periods were observed rather than exact values [@Reich:2009jq]. The data used for these analyses are publicly available at https://github.com/reichlab/activemonitr (working version of code and manuscript), or at https://doi.org/10.5281/zenodo.260135 (static release as of 26 January 2017). 
