...
## read in data
d <- read.csv('data/mers-cov/data_mers.csv')
...
save(pstr_gamma_params_mers, 
     file=paste0('data/mers-cov/', todays_date, '-pstr-gamma-distr-params-mers.rda'))
...
save(kde_mers, file=paste0('data/mers-cov/', todays_date, '-kde-mers.rda'))
